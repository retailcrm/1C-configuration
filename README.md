...
Удялать расширение нельзя, так как в него добавлены метаданные. После удаления расширения с дальнейшей установкой - данные будут очищены, что приведет к ошибкам в интеграции.
