## Модули для УТ 11.5, КА 2.5, ERP 2.5
...
Если попытаться установить расширение на старой платформе, возникнет ошибка: _Обнаружены проблемы при применении расширения конфигурации. Добавление дочерних объектов этого типа к заимствованным в расширениях нелдопустимо в режиме совместимости 8.3.16 и ниже_.
