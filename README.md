...
* RetailCRM_extension_UT11.4.13 (Для релизов до версии 11.4.13.282 включительно, режим совместимости 8.3.14). Модуль актуальный и дорабатывается
